...
* [Future AGI](https://github.com/future-agi/future-agi) ⭐ 1,936 | 🐛 818 | 🌐 Python | 📅 2026-09-05 - Open-source end-to-end LLM/agent platform with OpenTelemetry-native tracing (via traceAI), evals, simulations, gateway, and guardrails. Auto-instruments 20+ AI frameworks and LLM providers.
...
* [F5](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/main/exporter/f5cloudexporter) ⭐ 4,905 | 🐛 944 | 🌐 Go | 📅 2026-09-05
* Embrace ([Android](https://github.com/embrace-io/embrace-android-sdk) ⭐ 191 | 🐛 12 | 🌐 Kotlin | 📅 2026-09-04 | [iOS](https://github.com/embrace-io/embrace-apple-sdk) ⭐ 143 | 🐛 25 | 🌐 Swift | 📅 2026-09-04)
* [Aspecto](https://www.aspecto.io/)
...
For vendor specific receivers/exporters, see [OpenTelemetry Collector Contrib](https://github.com/open-telemetry/opentelemetry-collector-contrib) ⭐ 4,905 | 🐛 944 | 🌐 Go | 📅 2026-09-05
...
> [source](https://github.com/open-telemetry/opentelemetry-collector/blob/main/receiver/README.md) ⭐ 7,497 | 🐛 695 | 🌐 Go | 📅 2026-09-04

[List of supported receivers](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/main/receiver) ⭐ 4,905 | 🐛 944 | 🌐 Go | 📅 2026-09-05

#### Processors

> Processors are run on data between being received and being exported. Processors are optional though [some are recommended](https://github.com/open-telemetry/opentelemetry-collector/tree/main/processor#recommended-processors) ⭐ 7,497 | 🐛 695 | 🌐 Go | 📅 2026-09-04.
> [source](https://opentelemetry.io/docs/collector/configuration/#processors)

[List of supported processors](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/main/processor) ⭐ 4,905 | 🐛 944 | 🌐 Go | 📅 2026-09-05

#### Exporters

> An exporter is how you send data to one or more backends/destinations. Exporters may support one or more data sources.

[List of supported exporters](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/main/exporter) ⭐ 4,905 | 🐛 944 | 🌐 Go | 📅 2026-09-05
...
* [SkyWalking](https://github.com/apache/skywalking) ⭐ 24,941 | 🐛 41 | 🌐 Java | 📅 2026-09-05 - open source APM system
* [Jaeger](https://github.com/jaegertracing/jaeger) ⭐ 23,190 | 🐛 564 | 🌐 Go | 📅 2026-09-05 - distributed tracing platform created by Uber Technologies
* [GreptimeDB](https://github.com/GreptimeTeam/greptimedb) ⭐ 6,629 | 🐛 249 | 🌐 Rust | 📅 2026-09-05 - open source unified observability database for metrics, logs, and traces
...
* [Jaeger](https://github.com/jaegertracing/jaeger-ui) ⭐ 1,525 | 🐛 249 | 🌐 TypeScript | 📅 2026-09-05
* [Teletrace](https://github.com/teletrace/teletrace) ⚠️ Archived
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 132 | 🐛 120 | 🌐 TypeScript | 📅 2026-09-05 - Open source AI-powered multi-cluster Kubernetes dashboard with OpenTelemetry support for real-time observability across hybrid edge and cloud. CNCF Sandbox project.
* [TelemetryHub](https://telemetryhub.com/)
* [Zipkin](https://zipkin.io)
...
* [Mailing Lists](https://github.com/open-telemetry/community#mailing-lists) ⭐ 1,118 | 🐛 159 | 🌐 Python | 📅 2026-09-04
* [OpenTelemetry community content](https://github.com/open-telemetry/community) ⭐ 1,118 | 🐛 159 | 🌐 Python | 📅 2026-09-04
